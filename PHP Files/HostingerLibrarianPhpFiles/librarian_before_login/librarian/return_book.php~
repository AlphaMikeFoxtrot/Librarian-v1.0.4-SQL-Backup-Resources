<?php
    ...
    if(mysqli_num_rows($response) > 0){
        ...
        if(mysqli_query($connection, $sql_query_update_books) && mysqli_query($connection, $currently_issued_books) && mysqli_query($connection, $sql_query_update_return_book_log) && mysqli_query($connection, $sql_query_update_books)){
            echo "success";
        } else {
